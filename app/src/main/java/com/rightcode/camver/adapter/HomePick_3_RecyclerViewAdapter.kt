...
class HomePick_3_RecyclerViewAdapter(
    val context: Activity?,
    val data: ArrayList<type>
): RecyclerView.Adapter<HomePick_3_RecyclerViewAdapter.ViewHolder>()  {
    inner class ViewHolder(val binding: ItemHomePick3Binding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
           return ViewHolder(ItemHomePick3Binding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
